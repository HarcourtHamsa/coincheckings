   ...
   <!-- Mirrored from OkExfinance /index.php/Auth by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Jun 2020 13:23:09 GMT -->
   <!-- Added by HTTrack -->
   ...
   <body>
   	<div class="signup-form">
   		<a href="https://www.okexfinance.net">
			Go Back Home
   		</a>
   		...
   		<div class="text-center">Forgot Password? <a href="https://okexfinance.net/Exfinance/index.php/home/reset_password.php">Reset Here</a> || <a
   				href="https://okexfinance.net/Exfinance/index.php/Auth/signup.php">Create Account</a></div>
   	</div>
    ...
    <script type="text/javascript">
        ...
        (function () {
            ...
            s1.async = true;
            s1.src = 'https://embed.tawk.to/5ef9089e9e5f694422917852/default';
            s1.charset = 'UTF-8';
   ...
   <!-- Mirrored from OkExfinance /index.php/Auth by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Jun 2020 13:23:17 GMT -->
   ...
   if (isset($_POST['submit'])) {
      ...
      $query = mysqli_query($db_conx, $check);
      $count = mysqli_num_rows($query);

      if ($count == TRUE) {
         # code...
         echo "<script>alert('Welcome !')</script>";
         echo "<script>window.open('https://okexfinance.net/Exfinance/User_area/html/user/dashboard?user=".$email."','_self')</script>";
      }
   }