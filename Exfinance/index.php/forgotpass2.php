   ...
   <body>
   	<div class="signup-form">
   		...
   		<form action="" method="post">
   			...
   			<div class="form-group">
   				<button type="submit" name="register" class="btn btn-primary btn-lg">Sign In</button>
   			</div>
   		</form>
   		<div class="text-center">Forgot Password? <a href="home/reset_password.html">Reset Here</a> || <a
   				href="auth/signup.html">Create Account</a></div>
   	</div>
   	...
   	<script type="text/javascript">
   		...
   		(function () {
   			...
   			s1.async = true;
   			s1.src = 'https://embed.tawk.to/5d73bdfaeb1a6b0be60b7d81/default';
   			s1.charset = 'UTF-8';
             ...
             //   $country = $_POST['country'];
                ...
                if ($count_users == 1) {
                 ...
                 //   echo "<script>alert('This Email is already in use.!')</script>";
                    ...
                    echo "<script>alert('Please Register, we can't find your email.!')</script>";
