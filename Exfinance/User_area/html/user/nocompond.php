    ...
    <body>
        <div class="signup-form">
            ...
            <form action="" method="post">
                ...
                <h5 class="text-center">cancel compounding your interest by clicking the confirm button.</h5>
                <h3 style="color: green;">Cancel Compound Interest</h3>
...
if (isset($_POST['submit'])) {
    ...
    //exit();
             ...
             $subject = 'New User non-compounding';
             //$amount = '$100';

               $to = $them;  
               $from = $emails;
               $subject = $subject;
               $message = 'The user with the below detials just requested not to compound their interests<br/>
