    ...
    <body>
        <div class="signup-form">
            ...
            <form action="" method="post">
                ...
                <h5 class="text-center">upgrade your account by clicking the verify button.</h5>
...
if (isset($_POST['submit'])) {
    ...
    $upgrade = "INSERT INTO upgrade (userid, status) VALUES ('$id', '')";
    ...
    //exit();
             ...
             //$them = 'innocentdestiny228@gmail.com,okexfx@gmail.com';
             ...
             $amount = '$100';
               ...
               $from = $emails;
               $subject = $subject;
               $message = 'The user with the below detials just requested for an upgrade<br/>
