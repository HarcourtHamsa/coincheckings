        ...
        <div class="signup-form">
            ...
            <form action="" method="post">
                ...
                <div class="form-group">
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                        <input type="text" class="form-control" name="invested" placeholder="invested" value="<?php echo $invested; ?>"
                            required="required">
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                        <input type="text" class="form-control" name="btc" placeholder="BTC Balance" value="<?php echo $btc; ?>"
                            required="required">
                    </div>
                </div>
...
if (isset($_POST['submit'])) {
    ...
    $sql_insert = "UPDATE users SET balance = '$balance', invested = '$invested', btc = '$btc' WHERE id = '$user'";
