            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-md-8 contact-form">
                        ...
                        <!-- Contact Form Starts -->
                        <form class="form-contact" method="post" action="http://slimhamdi.net/Coincheckings/php/process-form.php">
                            <!-- Input Field Starts -->
                            ...
                            <div class="contact-page-info">
                                ...
                                <div class="contact-info-box">
                                    ...
                                    <div class="contact-info-box-content">
                                        ...
                                        <p><a href="mailto:coincheckings@gmail.com"></a> coincheckings@gmail.com</p>
                                    </div>
                                </div>
				...
				<div class="container">
					<div class="row">
						<div class="col-xs-12">
							...
							<p class="action-btn"><?php echo $disabled; ?></p>
...
<!-- Mirrored from slimhamdi.net/Coincheckings/contact.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Jan 2021 10:13:38 GMT -->
</html>
