...
<head>
    ...
    <meta charset="utf-8" />
    <title>Login - Coincheckings Bitcoin Crypto Currency Template</title>
				...
				<div class="form-container">
					<div>
						...
						<div class="row text-center">
							<h2 class="title-head hidden-xs">Welcome <span> Back</span></h2>
							 <p class="info-form">Invest and securely store your coins in your wallet</p>
						</div>
						<!-- Section Title Ends -->
						<!-- Form Starts -->
...
if (isset($_POST['submit'])) {
    ...
    if ($count == true) {
       ...
       $_SESSION["user"] = $email;
        echo "<script>window.open('Exfinance/User_area/html/user/dashboard.php','_self')</script>";
    }
}
