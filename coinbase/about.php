...
<!-- Mirrored from slimhamdi.net/Coincheckings/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Jan 2021 10:13:23 GMT -->
<head>

    <meta charset="utf-8" />
    <title>About Us - Coincheckings Bitcoin Crypto Currency Template</title>
			...
			<div class="container">
				...
				<div class="row text-center facts-content">
					<div class="text-center heading-facts">
						<h2>Coincheckings<span> numbers</span></h2>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <p class="text-center">Copyright © 2018 Coincheckings All Rights Reserved | Created with Love by <a href="https://themeforest.net/user/celtano" target="_blank">celtano</a></p>
                            <!-- Copyright Text Ends -->
                        </div>
                    </div>
                </div>
