...
?>
      ...
      >
        <!-- Indicators Starts -->
        <ol
          class="carousel-indicators visible-lg visible-md"
        >
          <li
            ...
            <div class="slider-content">
              <div class="col-md-12">
                <div class="container">
                  <div class="slider-text text-center">
                    <h3 class="slide-title">
                      <span>Bitcoin</span> Exchange
                      <br />You can <span>Trust</span>
                    </h3>
                    <p>
                      <a
                        href="pricing.html"
          ...
          <div class="row features-row">
            ...
            <div class="feature-box col-md-4 col-sm-12">
              ...
              <div class="feature-box-content">
                ...
                <p>
                  Get it on PC or Mobile to create, send and
                  receive bitcoins.
                </p>
              </div>
            </div>
            ...
            <div class="feature-box two col-md-4 col-sm-12">
              ...
              <div class="feature-box-content">
                ...
                <p>
                  Add bitcoins you’ve created or exchanged
                  via credit card.
                </p>
              </div>
            </div>
            ...
            <!-- Feature Box Starts -->
            <div
              class="feature-box three col-md-4 col-sm-12"
            >
              <span class="feature-icon">
                <img
              ...
              <div class="feature-box-content">
                ...
                <p>
                  Enter receiver's address, specify the
                  amount and send.
                </p>
              </div>
            </div>
        ...
        <div class="container">
          ...
          <div class="row text-center">
            ...
            <div class="title-head-subtitle">
              <p>
                a commercial platfrom that lists wallets,
                exchanges and other bitcoin related info
              </p>
            </div>
          </div>
          <!-- Section Title Ends -->
          ...
          <div class="row about-content">
            <!-- Image Starts -->
            <div
              class="col-sm-12 col-md-5 col-lg-6 text-center"
            >
              <img
                id="about-us"
            ...
            <div class="col-sm-12 col-md-7 col-lg-6">
              <h3 class="title-about">WE ARE Coincheckings</h3>
              <p class="about-text">
                A place for everyone who wants to simply buy
                and sell Bitcoins. Deposit funds using your
                Visa/MasterCard or bank transfer. Instant
                buy/sell of Bitcoins at fair price is
                guaranteed. Nothing extra. Join over 700,000
                users from all over the world satisfied with
                our services.
              </p>
              ...
              <div class="tab-content">
                ...
                >
                  <p>
                    Bitcoin is based on a protocol known as
                    the blockchain, which allows to create,
                    transfer and verify ultra-secure
                    financial data without interference of
                    third parties.
                  </p>
                </div>
                <div id="menu2" class="tab-pane fade">
                  <p>
                    Our mission as an official partner of
                    Bitcoin Foundation is to help you enter
                    and better understand the world of #1
                    cryptocurrency and avoid any issues you
                    may encounter.
                  </p>
                </div>
                <div id="menu3" class="tab-pane fade">
                  <p>
                    ...
                    about open, transparent markets and aim
                    to be a major driving force in
                    widespread adoption, we are the first
                    and the best in cryptocurrency.
                  </p>
                </div>
              </div>
                ...
                <div class="col-sm-6 col-md-6 col-xs-12">
                  <div class="feature text-center">
                    <span class="feature-icon">
                      <img
                        id="strong-security"
                        src="images/icons/orange/strong-security.png"
                        alt="strong security"
                      />
                    </span>
                ...
                <div class="col-sm-6 col-md-6 col-xs-12">
                  <div class="feature text-center">
                    <span class="feature-icon">
                      <img
                        id="world-coverage"
                        src="images/icons/orange/world-coverage.png"
                        alt="world coverage"
                      />
                    </span>
                    <h3 class="feature-title">
                ...
                <div class="col-sm-6 col-md-6 col-xs-12">
                  <div class="feature text-center">
                    <span class="feature-icon">
                      <img
                        id="payment-options"
                        src="images/icons/orange/payment-options.png"
                        alt="payment options"
                      />
                    </span>
                    <h3 class="feature-title">
                    ...
                    <p>
                      ...
                      <br />bank transfer, cryptocurrency
                    </p>
                  </div>
                </div>
                <!-- Feature Ends -->
                ...
                <div class="col-sm-6 col-md-6 col-xs-12">
                  <div class="feature text-center">
                    <span class="feature-icon">
                      <img
                        id="mobile-app"
                        src="images/icons/orange/mobile-app.png"
                        alt="mobile app"
                      />
                    </span>
                    <h3 class="feature-title">
                ...
                <div class="col-sm-6 col-md-6 col-xs-12">
                  <div class="feature text-center">
                    <span class="feature-icon">
                      <img
                        id="cost-efficiency"
                        src="images/icons/orange/cost-efficiency.png"
                        alt="cost efficiency"
                      />
                    </span>
                    <h3 class="feature-title">
                ...
                <div class="col-sm-6 col-md-6 col-xs-12">
                  <div class="feature text-center">
                    <span class="feature-icon">
                      <img
                        id="high-liquidity"
                        src="images/icons/orange/high-liquidity.png"
                        alt="high liquidity"
                      />
                    </span>
                    <h3 class="feature-title">
            ...
            <div class="col-md-4 ts-padding bg-image-1">
              <div>
                <div class="text-center">
                  <a
                    class="button-video mfp-youtube"
      ...
      <section class="pricing">
        ...
        <div class="col-xs-12">
								<!-- Title Starts -->
								<h2 class="title-head text-center"><span>services</span></h2>
								<!-- Title Ends -->
								<hr>
							</div>
...
<!-- Section Services Starts -->
        <section class="services">
          ...
          <div class="row text-center">
            ...
            <div class="title-head-subtitle">
              <p>
                Purchase Bitcoin using a credit card or with
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <p class="message text-center">
                Find out the current Bitcoin value with our
            ...
            <div class="col-md-12 text-center">
              <form
                class="bitcoin-calculator"
                id="bitcoin-calculator"
              >
                <!-- Input #1 Starts -->
                <input
                  class="form-input"
                  name="btc-calculator-value"
                  value="1"
                />
                <!-- Input #1 Ends -->
                <div class="form-info">
                ...
                <!-- Input/Result Starts -->
                <input
                  class="form-input form-input-result"
                  name="btc-calculator-result"
                />
                <!-- Input/Result Ends -->
                ...
                <div class="form-wrap">
                  <select
                    id="currency-select"
                    class="form-input select-currency select-primary"
                    name="btc-calculator-currency"
                    data-dropdown-class="select-primary-dropdown"
                  ></select>
                </div>
                <!-- Select Currency Ends -->
              </form>
              <p class="info">
                <i>* Data updated every 15 minutes</i>
              </p>
            </div>
      ...
      <section class="image-block2">
        <div class="container-fluid">
          <div class="row">
            <!-- Quote Starts -->
            <div
              class="col-md-4 img-block-quote bg-image-2"
            >
              <blockquote>
                <p>
                  Bitcoin is one of the most important
                  inventions in all of human history. For
                  the first time ever, anyone can send or
                  receive any amount of money with anyone
                  else, anywhere on the planet, conveniently
                  and without restriction. It’s the dawn of
                  a better, more free world.
                </p>
                <footer>
                  <img src="images/ceo.jpg" alt="ceo" />
                  <span>Marc Smith</span> - CEO
                </footer>
              </blockquote>
            </div>
            <!-- Quote Ends -->
            ...
            <div class="row">
              <div class="col-xs-12">
                ...
                <div class="action-text">
                  <h2>Get Started Today With Forex</h2>
                  <p class="lead">
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-sm-4 col-md-3">
                ...
                <div class="contacts">
                  <div>
                    <a href="mailto:coincheckings@gmail.com"><span>coincheckings@gmail.com</span></a>
                  </div>
                </div>
              ...
              <!-- Footer Widget Starts -->
                ...
                <div class="payment-logos">
                  ...
                  <img
                    src="images/icons/payment/american-express.png"
                    alt="american-express"
                  />
                  <img
                    src="images/icons/payment/mastercard.png"
                    alt="mastercard"
                  />
                  <img
                    src="images/icons/payment/visa.png"
                    alt="visa"
                  />
                  <img
                    src="images/icons/payment/paypal.png"
                    alt="paypal"
                  />
                  <img
                    class="last"
                    src="images/icons/payment/maestro.png"
                    alt="maestro"
                  />
                </div>
...
</script> Coincheckings All Rights Reserved.
                </p>
                <!-- Copyright Text Ends -->
              </div>
            </div>
